...
tableBody.addEventListener("click", (e) => {
  ...
  if (btn) {
    ...
    let currentStatus = btn.getAttribute("currentStatus");
...
function renderTable() {
  ...
  paginatedUsers.forEach((user) => {
    ...
    row.innerHTML = `
            ...
            <td>
                <button 
                    class="status-btn btn btn-primary btn-sm ${buttonClass}" 
                    data-id="${user.id}" 
  ...
  updatePagination();
  console.log(
    `📊 Displayed ${paginatedUsers.length} of ${filteredUsers.length} users (Page ${currentPage})`,
  );
}
